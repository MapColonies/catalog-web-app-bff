...
import { Layer3DRecord, LayerDemRecord, LayerRasterRecord, VectorBestRecord, QuantizedMeshBestRecord } from '../../AUTOGENERATED/GraphQLClass';
import { CatalogManager } from '../../common/catalog-manager/catalog-manager';
import { END, HttpError, Services, START } from '../../common/constants';
...
export class LayerMetadataMixedResolver {
  ...
  public async search(
    ...
    try {
      ...
      this.logger.error(`[CSW][search][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async searchById(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][searchById][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async getDomain(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][getDomain][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async getProduct(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][getProduct][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async updateStatus(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][updateStatus][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async updateMetadata(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][updateMetadata][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async startRasterIngestion(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][startRasterIngestion][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async startRasterUpdateGeopkg(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][startRasterUpdateGeopkg][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async start3DIngestion(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][start3DIngestion][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async startDemIngestion(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][startDemIngestion][ERROR] ${message}`);
      throw err;
    }
  }
  ...
  public async deleteLayer(
    ...
    try {
      ...
      const message = (err as HttpError).response?.data?.message ?? (err as Error).message;
      this.logger.error(`[CSW][deleteLayer][ERROR] ${message}`);
      throw err;
    }
  }
}

export type LayerMetadataUnionType = LayerDemRecord | Layer3DRecord | LayerRasterRecord | VectorBestRecord | QuantizedMeshBestRecord;
