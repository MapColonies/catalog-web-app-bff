...
export class LayerMetadataMixedResolver {
  ...
  public async searchById(
    ...
    try {
      ...
      this.logger.error(`[CSW][searchById][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async getDomain(
    ...
    try {
      ...
      this.logger.error(`[CSW][getDomain][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async updateStatus(
    ...
    try {
      ...
      this.logger.error(`[CSW][updateStatus][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async updateMetadata(
    ...
    try {
      ...
      this.logger.error(`[CSW][updateMetadata][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async startRasterIngestion(
    ...
    try {
      ...
      this.logger.error(`[CSW][startRasterIngestion][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async start3DIngestion(
    ...
    try {
      ...
      this.logger.error(`[CSW][start3DIngestion][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
  ...
  public async startDemIngestion(
    ...
    try {
      ...
      this.logger.error(`[CSW][startDemIngestion][ERROR] ${extractErrorMessage(err)}`);
      throw err;
    }
  }
