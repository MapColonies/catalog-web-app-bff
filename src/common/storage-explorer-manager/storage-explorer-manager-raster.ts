...
interface RasterIngestionFilesStructure {
  data: {
    allowedExt: string[];
...
export class StorageExplorerManagerRaster implements IStorageExplorerManagerService {
  ...
  private readonly rasterIngestionFilesStructure: RasterIngestionFilesStructure;
  ...
  public constructor(private readonly config: IConfig, private readonly logger: Logger) {
    ...
    this.rasterIngestionFilesStructure = JSON.parse(this.config.get('rasterIngestionFilesStructure')) as RasterIngestionFilesStructure;
  }
...
export { RasterIngestionFilesStructure };
