...
export type RasterIngestionFilesStructure = {
  data: {
    allowedExt: string[];
...
export class StorageExplorerManagerRaster implements IStorageExplorerManagerService {
  ...
  public constructor(private readonly config: IConfig, private readonly logger: Logger) {
    ...
    this.rasterIngestionFilesStructure = JSON.parse(this.config.get('rasterIngestionFilesStructure'));
  }
  ...
  public async getDirectory(data: ExplorerGetByPath, ctx: IContext): Promise<File[]> {
    ...
    const fileConfig = data.rasterIngestionFilesType ? this.rasterIngestionFilesStructure[data.rasterIngestionFilesType] : undefined;
