...
type IRasterIngestionFilesStructure = Record<RasterFileType, IRasterFileGroup>;
...
export class StorageExplorerManagerRaster implements IStorageExplorerManagerService {
  ...
  private readonly rasterIngestionFilesStructure: IRasterIngestionFilesStructure;
  ...
  public constructor(private readonly config: IConfig, private readonly logger: Logger) {
    ...
    this.rasterIngestionFilesStructure = JSON.parse(this.config.get('rasterIngestionFilesStructure')) as IRasterIngestionFilesStructure;
  }
  ...
  public async getDirectory(data: ExplorerGetByPath, ctx: IContext): Promise<File[]> {
    ...
    const fileConfig = data.rasterIngestionFilesType !== undefined ? this.rasterIngestionFilesStructure[data.rasterIngestionFilesType] : undefined;

    const targetFileType = data.rasterIngestionFilesType;
...
export { IRasterIngestionFilesStructure };
