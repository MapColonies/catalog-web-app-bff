...
import { ExplorerGetByPath, ExplorerGetById, ExplorerResolveMetadataAsModel, ExplorerGetByFolderPath } from '../../graphql/inputTypes';
...
export class StorageExplorerManager3D implements IStorageExplorerManagerService {
  ...
  public constructor(private readonly config: IConfig, private readonly logger: Logger) {
    ...
    this.bufferSize = Number(this.config.get('storageExplorerServices.3d.bufferSize'));
  }
  ...
  public async getDirectoryById(data: ExplorerGetById, ctx: IContext): Promise<File[]> {
    this.logger.info(`[StorageExplorer][3D][getDirectoryById] ${stringifyParams(data)}`);
  ...
  public async getFile(data: ExplorerGetByPath, ctx: IContext): Promise<Layer3DRecord> {
    this.logger.info(`[StorageExplorer][3D][getFile] ${stringifyParams(data)}`);
  ...
  public async getStreamFile(data: ExplorerGetByPath, ctx: IContext): Promise<AxiosResponse<Readable>> {
    this.logger.info(`[StorageExplorer][3D][getStreamFile] ${stringifyParams(data)}`);
  ...
  public async getZipShapefile(data: ExplorerGetByFolderPath, ctx: IContext): Promise<AxiosResponse<Readable>> {
    this.logger.info(`[StorageExplorer][3D][getZipShapefile] ${stringifyParams(data)}`);
  ...
  public async writeStreamFile(data: ExplorerGetByPath, req: Request, ctx: IContext): Promise<AxiosResponse> {
    this.logger.info(`[StorageExplorer][3D][writeStreamFile] ${stringifyParams(data)}`);
  ...
  public async resolveMetadataAsModel({ metadata }: ExplorerResolveMetadataAsModel, ctx: IContext): Promise<Layer3DRecord> {
    this.logger.info(`[StorageExplorer][3D][resolveMetadataAsModel] metadata: ${JSON.stringify(metadata)}`);
  ...
  public async getFileById(data: ExplorerGetById, ctx: IContext): Promise<Layer3DRecord> {
    this.logger.info(`[StorageExplorer][3D][getFileById] ${stringifyParams(data)}`);
  ...
  public async getDecryptedId(data: ExplorerGetById, ctx: IContext): Promise<{ data: string }> {
    this.logger.info(`[StorageExplorer][3D][getDecryptedId] ${stringifyParams(data)}`);
