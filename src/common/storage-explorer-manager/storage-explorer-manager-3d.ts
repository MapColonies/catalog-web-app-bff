...
export class StorageExplorerManager3D implements IStorageExplorerManagerService {
  ...
  public async getStreamFile(data: ExplorerGetByPath, ctx: IContext): Promise<Stream> {
    this.logger.info(`[StorageExplorerManagerRaster][getStreamFile] fetching file with data: ${data}.`);
  ...
  public async writeStreamFile(data: ExplorerGetByPath, file: Express.Multer.File, ctx: IContext): Promise<Stream> {
    this.logger.info(`[StorageExplorerManagerRaster][writeStreamFile] writing file with data: ${data}.`);
