...
export class StorageExplorerManager3D implements IStorageExplorerManagerService {
  ...
  public async getDirectoryById(data: ExplorerGetById, ctx: IContext): Promise<File[]> {
    this.logger.info(`[StorageExplorer][3D][getDirectoryById] ${stringifyObject(data)}`);
  ...
  public async getFile(data: ExplorerGetByPath, ctx: IContext): Promise<Layer3DRecord> {
    this.logger.info(`[StorageExplorer][3D][getFile] ${stringifyObject(data)}`);
  ...
  public async getStreamFile(data: ExplorerGetByPath, ctx: IContext): Promise<AxiosResponse<Readable>> {
    this.logger.info(`[StorageExplorer][3D][getStreamFile] ${stringifyObject(data)}`);
  ...
  public async getZipShapefile(data: ExplorerGetByFolderPath, ctx: IContext): Promise<AxiosResponse<Readable>> {
    this.logger.info(`[StorageExplorer][3D][getZipShapefile] ${stringifyObject(data)}`);
  ...
  public async writeStreamFile(data: ExplorerGetByPath, req: Request, ctx: IContext): Promise<AxiosResponse> {
    this.logger.info(`[StorageExplorer][3D][writeStreamFile] ${stringifyObject(data)}`);
  ...
  public async getFileById(data: ExplorerGetById, ctx: IContext): Promise<Layer3DRecord> {
    this.logger.info(`[StorageExplorer][3D][getFileById] ${stringifyObject(data)}`);
  ...
  public async getDecryptedId(data: ExplorerGetById, ctx: IContext): Promise<{ data: string }> {
    this.logger.info(`[StorageExplorer][3D][getDecryptedId] ${stringifyObject(data)}`);
