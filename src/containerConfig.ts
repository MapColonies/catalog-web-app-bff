...
import { STREAM_FILE_ROUTER_SYMBOL, streamFileRouterFactory } from './stream-route/streamRouter';
...
function registerExternalValues(tracing: Tracing): void {
  ...
  container.register(STREAM_FILE_ROUTER_SYMBOL, { useFactory: streamFileRouterFactory });
